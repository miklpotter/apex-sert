...
--changeset mipotter:create_view_sert_core.evals_pub_v endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
create or replace view ${sert_core_schema}.evals_pub_v
as
