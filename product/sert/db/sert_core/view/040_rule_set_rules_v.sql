...
--changeset mipotter:create_view_sert_core.rule_set_rules_v endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
create or replace view ${sert_core_schema}.rule_set_rules_v
as
select
   rs.rule_set_id
  ,rs.rule_set_type_id
