...
--changeset mipotter:create_view_sert_core.rules_v endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
-- test
create or replace view ${sert_core_schema}.rules_v
as
select
   r.rule_id
  ,r.rule_name
