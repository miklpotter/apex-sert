...
--changeset mipotter:create_view_sert_core.comments_pub_v endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
create or replace view ${sert_core_schema}.comments_pub_v
as
select
   c.comment_id
