...
--changeset mipotter:create_view_sert_core.eval_results_pub_v endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
create or replace view ${sert_core_schema}.eval_results_pub_v
as
select
   er.eval_result_id
  ,er.eval_id
