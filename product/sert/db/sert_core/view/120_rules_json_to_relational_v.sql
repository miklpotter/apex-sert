...
--changeset mipotter:create_view_sert_core.rules_json_to_relational_v endDelimiter:/ runOnChange:true runAlways:false rollbackEndDelimiter:/
create or replace view ${sert_core_schema}.rules_json_to_relational_v as
select
   j.rule_name
  ,j.rule_key
  ,j.category_name
